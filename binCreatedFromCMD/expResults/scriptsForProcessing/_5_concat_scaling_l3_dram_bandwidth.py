...
def concat_scaling_l3_dram_bandwidth(output_dir,base_path,float_format_decimals,stream_scaling_dram_path):
    ...
    df_cpu.insert(len(df_cpu.columns)-3,'L3-DRAM-Bandwidth-Scaling',value=df_stream_bandwidth['STREAM-COPY'])
    # df_cpu['L3-DRAM-Bandwidth']= df_stream_bandwidth['STREAM-COPY']
    df_cpu.loc[0,'L3-DRAM-Bandwidth-Scaling']=original_single_l3_dram_bandwidth
